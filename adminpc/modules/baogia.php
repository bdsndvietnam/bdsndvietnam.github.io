...
$stv = new Smarty( );
$q2 = mysql_query( "SELECT * FROM thanhvien order by hovaten asc" );
...
$sql = query( "SELECT sim1,sim2,gianhap,simdl FROM simso ".$where." ".$_GET['post']['oder'].( " ".$limit ) );
$dem = mysql_num_rows( query( "SELECT sim2 FROM simso ".$where." ".$_GET['post']['oder']."" ) );
$stv->assign( "mysql", urlencode( "SELECT sim1,sim2,gianhap,simdl FROM simso ".$where." ".$_GET['post']['oder']."" ) );
