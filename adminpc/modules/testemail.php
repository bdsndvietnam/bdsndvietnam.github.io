...
while ( $r = fecth( $q ) )
{
	...
	$txt[$v] .= "<tr>\r\n\t\t<td bgcolor=\"#FFFFFF\" height=\"22\" colspan=\"8\"><b>Tổng cộng</b> : <b>".$tong[$v]." K</b><br/> Nếu có sai lệch gì anh / chị vui lòng báo lại.<br /> 0914.77.9999 - 0937.666.886 - 0986.77.8668</td>\r\n\t</tr>\r\n\t</table>";
	if ( 0 < mysql_num_rows( $q2 ) )
	{
		mail( "nganhangsimsodep.com@gmail.com", $r['email']."Bao cao tu dong gui ngay ".date( "d/m/Y" ), $txt[$v], $headers );
	}
}
?>
