...
if ( isset( $_POST['submit'] ) )
{
	...
	update( $_POST['post'], "menu", "mid=".$_GET['id'] );
}
$q = query( "SELECT menu AS tenmuc, mid AS cid FROM menu WHERE menu!='' ORDER By mgr" );
while ( $r = fecth( $q ) )
{
	$tenmuc[] = $r['tenmuc'];
	$cid[] = $r['cid'];
}
$q2 = query( "SELECT * FROM menu WHERE mid=".$_GET['id'] );
$stv->assign( $r2 = fecth( $q2 ) );
if ( $r2['menu'] != "" )
{
	$stv->assign( "menu", $r2['menu'] );
}
else
{
